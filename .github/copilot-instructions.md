...
2. **Test-Driven** — Write tests before implementation, 100% coverage required.
...
- **TDD Workflow:** (1) Write failing test (RED), (2) minimal implementation (GREEN), (3a) break code to show tests fail (RED), (3b) revert code changes (GREEN), (4) Refactor (IMPROVE).
